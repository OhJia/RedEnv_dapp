...
module.exports = function(callback) {
	...
	RedEnvelope.deployed().then(function(i) {i.buyEnvelope('passcode', {from: web3.eth.accounts[2], value: amt_1}).then(function(f) {console.log(f)})});
	RedEnvelope.deployed().then(function(i) {i.buyEnvelope('testpasscode', {from: web3.eth.accounts[3], value: amt_1}).then(function(f) {console.log(f)})});	
